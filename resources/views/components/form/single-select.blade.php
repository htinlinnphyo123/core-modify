@props(['title', 'required' => false, 'name','id','hasSearch'=>false])
<x-form.control>
    ...
    "optionClasses": "py-2 px-4 w-full text-sm text-gray-800 cursor-pointer hover:bg-gray-200 bg-gray-100 border-b-2 last:border-0 border-gray-300 text-gray-900 text-md dark:bg-gray-100 dark:hover:bg-gray-200 dark:text-gray-900 tracking-wider",
