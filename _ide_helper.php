...
namespace Illuminate\Routing {
    ...
    class ResponseFactory {
         ...
         * 
         *
         * @see \App\Providers\ResponseMacroProvider::boot()
         * @param string $path
         * @param array $data
         * @return \Illuminate\Contracts\View\View 
         * @static 
         */
        public static function successView($path, $data)
        {
            return \Illuminate\Routing\ResponseFactory::successView($path, $data);
        }
         ...
         * @static 
         */
        public static function successIndexRedirect($model, $message, $index = 'index')
        {
            return \Illuminate\Routing\ResponseFactory::successIndexRedirect($model, $message, $index);
        }
         ...
         * @static 
         */
        public static function successShowRedirect($model, $id, $message, $show = 'show')
        {
            return \Illuminate\Routing\ResponseFactory::successShowRedirect($model, $id, $message, $show);
        }
         ...
         * @static 
         */
        public static function redirectBackWithError($repository, $message)
        {
            return \Illuminate\Routing\ResponseFactory::redirectBackWithError($repository, $message);
        }
...
namespace  {
    ...
    class MiniCRUDGenerator extends \Davion153808\MiniCRUDGenerator\MiniCRUDGeneratorFacade {}
